<div>
    ...
    <section class="bg-black py-10">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="mt-10">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-center">
                            <img src="{{ asset('img/images/fam.png') }}"
                                class="w-44 h-44 object-contain object-center">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-center">
                            <img src="{{asset('img/images/ganar.png')}}" class="w-44 h-44 object-contain object-center">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-20">
                <h1 class="text-center font-josefin text-2xl font-bold text-white">¿CÓMO FUNCIONA NUESTRO SISTEMA DE PAGO?</h1>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mt-4">
                    ...
                    <div>
                        <h1 class="font-josefin text-white font-bold text-center text-lg">2. QUE EL LECTOR DECIDA POTENCIAR SU APOYO</h1>
                        <div class="flex items-center justify-center">
                    ...
                    <div>
                        <h1 class="font-josefin text-rose-500 font-bold text-center text-lg">3. PAGARAN DIRECTAMENTE TU CONTENIDO</h1>
                        <div class="flex items-center justify-center">
                ...
                <form action="" wire:submit.prevent="store">
                    ...
                    <div
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex">
                                <span
                                    class="inline-flex items-center px-3 text-sm text-white bg-blue-600 rounded-l-full border border-r-0 border-gray-300 dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                                    @
                                </span>
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex">
                                <span
                                    class="inline-flex items-center px-3 text-sm text-white bg-gradient-to-r from-red-600 via-orange-600  to-yellow-500 rounded-l-full border border-r-0 border-gray-300 dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                                    @
                                </span>
